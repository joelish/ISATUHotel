                               ...
                               <div class="traveler-info">
                                    ...
                                    <div class="payment-method">
                                        ...
                                        <input type="checkbox" id="check01" name="checkbox"/>
                                            <label for="check01"><span><i class="fa fa-check"></i></span>Apply the above information to all rooms</label>
                                            <br>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                                   <h3>Your reservation is confirmed now. Thank You!</h3>
                                   <p>Print the details form to know more about your hotel reservation.</p>
